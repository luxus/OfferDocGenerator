...
def config_generator(tmp_path):
    ...
    # Check if TEST_OUTPUT_DIR is already set (e.g., via command line)
    test_output_dir = os.getenv("TEST_OUTPUT_DIR", str(tmp_path / "config"))
    ...
    os.environ["TEST_OUTPUT_DIR"] = test_output_dir
